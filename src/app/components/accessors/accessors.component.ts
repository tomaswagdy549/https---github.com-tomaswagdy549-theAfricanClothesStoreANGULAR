...
@Component({
  ...
  styleUrl: './accessors.component.css'
})
export class AccessorsComponent implements OnInit {
  pageSize: number = 6;
  ...
  cards = [
    {
      id: 1,
      img: 'assets/images/socks.jpg',
      imgHover: 'assets/images/socks2.jpg',
      text: 'Card 1 description',
      price: 100
    },
    {
      id: 2,
      img: 'assets/images/belt.jpg',
      imgHover: 'assets/images/belt2.jpg',
      text: 'Card 1 description',
      price: 100
    },
    {
