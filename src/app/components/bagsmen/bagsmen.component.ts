...
@Component({
  ...
  templateUrl: './bagsmen.component.html',
  styleUrl: './bagsmen.component.css'
})
export class BagsmenComponent implements OnInit {
  pageSize: number = 6;
  ...
  cards = [
    {
      id: 1,
      img: 'assets/images/bagsmen.jpg',
      imgHover: 'assets/images/bagsmen2.jpg',
